...
import { getSession, getUserAccounts, getUserPasskeys, } from "@saas/auth/lib/server";
...
export default async function AccountSettingsPage() {
    ...
    const userHasPassword = userAccounts?.some((account) => account.provider === "credential");
