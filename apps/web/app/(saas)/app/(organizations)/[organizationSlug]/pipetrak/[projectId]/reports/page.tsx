  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gray-50 rounded-lg p-6 border">
        <h3 className="text-lg font-semibold mb-2 text-gray-900">Report Tips</h3>
        <div className="grid gap-4 md:grid-cols-2">
          <div>
            <h4 className="font-medium text-gray-900 mb-1">ROC Progress vs Standard Progress</h4>
            <p className="text-sm text-muted-foreground">
              ROC (Rate of Completion) considers component complexity and criticality, 
              providing more accurate project completion metrics than simple component counts.
            </p>
          </div>
          <div>
            <h4 className="font-medium text-gray-900 mb-1">Export Options</h4>
            <p className="text-sm text-muted-foreground">
              All reports support Excel, PDF, and CSV export formats with customizable 
              options including charts, raw data, and email delivery.
            </p>
          </div>
          <div>
            <h4 className="font-medium text-gray-900 mb-1">Real-time Data</h4>
            <p className="text-sm text-muted-foreground">
              Reports are generated from live data with intelligent caching. 
              Data is automatically refreshed when changes are detected.
            </p>
          </div>
          <div>
            <h4 className="font-medium text-gray-900 mb-1">Filtering and Search</h4>
            <p className="text-sm text-muted-foreground">
              Use advanced filters to focus on specific areas, systems, or date ranges. 
              Filters persist in URLs for easy sharing and bookmarking.
            </p>
          </div>
        </div>
      </div>
