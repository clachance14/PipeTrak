...
export default async function ProgressSummaryReportPage({ params, }) {
    const { projectId } = await params;
    return (<div className="space-y-6">
			<PageHeader title="Progress Summary Report" subtitle="Weekly progress report for P6 schedule updates with Tuesday 9 AM cutoff"/>
