	...
	const fetchProjects = async () => {
		...
		try {
			const response = await fetch(
				`/api/pipetrak/projects?organizationId=${activeOrganization.id}`,
			);
			if (response.ok) {
								...
								<CardContent className="space-y-4">
									...
									<div className="flex flex-col gap-2">
										<Button asChild className="w-full">
											<Link
												href={`/app/${activeOrganization.slug}/pipetrak/${project.id}/dashboard`}
											>
												Open Dashboard
											</Link>
										</Button>
										<div className="grid grid-cols-2 gap-2">
											<Button variant="outline" size="sm">
												<Link
													href={`/app/${activeOrganization.slug}/pipetrak/${project.id}/components`}
												>
													Components
												</Link>
											</Button>
											<Button variant="outline" size="sm">
												<Link
													href={`/app/${activeOrganization.slug}/pipetrak/${project.id}/import`}
												>
													Import
												</Link>
											</Button>
