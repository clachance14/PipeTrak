...
import { Plus, FolderOpen, MapPin, Calendar, BarChart3, AlertCircle, Building2, Loader2 } from "lucide-react";
    ...
    return (
      <div className="space-y-8">
        <PageHeader
          ...
          subtitle="Select a project to manage components and track progress"
        />
        <Alert>
          <AlertCircle className="h-4 w-4" />
          <AlertDescription>
            Unable to determine organization context. Please contact support.
          </AlertDescription>
        </Alert>
      </div>
    );
      ...
      {projects.length === 0 ? (
        <div className="space-y-6">
          <Alert>
            <AlertCircle className="h-4 w-4" />
            <AlertDescription>
              No projects found. Create your first project to get started with PipeTrak.
            </AlertDescription>
          </Alert>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Create a new project for {activeOrganization.name}
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="text-sm text-muted-foreground">
                ...
                <p className="mt-2">Run this command to seed the SDO Tank sample project</p>
              </div>
            </CardContent>
          </Card>
        </div>
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex items-center gap-2 text-muted-foreground">
                      ...
                      <span>
                        {project._count.components} components, {project._count.drawings} drawings
                      </span>
                    </div>
                  </div>
