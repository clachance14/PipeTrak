...
import type { Component, ComponentMilestone } from "@repo/database/prisma/generated/client";
...
export function ComponentDetailClient({ component: initialComponent, projectId, userId }: ComponentDetailClientProps) {
            ...
            <div className="flex items-start justify-between gap-2">
              <div className="min-w-0 flex-1">
                ...
                <p className="text-sm text-muted-foreground">
                  {[component.type, component.spec, component.size].filter(Boolean).join(' • ') || 'No specifications'}
                </p>
              </div>
            ...
            <div className="rounded-lg border p-2 bg-white flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <span className="text-xs text-muted-foreground">
                  {component.type} • {component.size} • {component.material}
                </span>
              </div>
