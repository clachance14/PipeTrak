...
export const metadata: Metadata = {
	...
	description:
		"Import field weld data from Excel files for quality control tracking",
};

export default async function QCImportPage({ params }: QCImportPageProps) {
	const { organizationSlug, projectId } = await params;

	return (
		<div className="space-y-6">
			<PageHeader
				title="Field Weld Import"
				subtitle="Import field weld data from Excel files for quality control tracking"
			/>
...
async function QCImportContent({
	projectId,
	organizationSlug,
}: {
	projectId: string;
	...
	return (
		<div className="max-w-4xl mx-auto space-y-6">
			...
			<nav className="flex items-center space-x-2 text-sm text-muted-foreground mb-6">
				<a
					href={`/app/${organizationSlug}/pipetrak/${projectId}`}
