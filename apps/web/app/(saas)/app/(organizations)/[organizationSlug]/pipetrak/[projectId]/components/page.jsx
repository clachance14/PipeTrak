...
export default async function ComponentsPage({ params }) {
    ...
    return (<div className="space-y-4 md:space-y-6 lg:space-y-8 px-4 md:px-6 lg:px-8">
			<PageHeader title="Components" subtitle="Track field updates, milestones, and progress for all components"/>
...
async function ComponentsContent({ projectId }) {
    ...
    if (components.length === 0) {
        return (<div className="space-y-4">
				<EmptyState title="No components yet" description="Import components from Excel or add them manually to get started."/>
