...
import { CreditCard, Settings, TriangleAlert, Users, } from "lucide-react";
...
export default async function SettingsLayout({ children, params, }) {
    ...
    const userIsOrganizationAdmin = isOrganizationAdmin(organization, session?.user);
    ...
    return (<>
			<PageHeader title={t("organizations.settings.title")} subtitle={t("organizations.settings.subtitle")}/>
