...
function DrawingDetailContent({ 
  ...
  const components = detailsData?.components || [];
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2">
          ...
          <div className="flex-1">
            <h1 className="text-lg font-semibold">{drawing.number}</h1>
          ...
          pagination={
            pagination
              ? {
                  ...
                  onPageChange: (page) =>
                    setComponentFilters((prev) => ({ ...prev, page })),
                }
              : undefined
          }
        />
              ...
              <div className="flex items-start justify-between mb-4">
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    {drawing.revision && (
                      <Badge variant="outline">Rev. {drawing.revision}</Badge>
                    )}
                  </div>
                    ...
                    >
                      ...
                      {child._count && (
                        <Badge variant="outline">
                          {child._count.components} components
                        </Badge>
                      )}
                    </button>
                  ))}
