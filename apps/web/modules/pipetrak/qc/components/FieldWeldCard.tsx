...
export function FieldWeldCard({
	...
	const systemLabel =
		fieldWeld.drawingSystem ?? fieldWeld.component?.system ?? "-";
	const weldTypeLabel =
		fieldWeld.weldType?.description ??
				...
				<CardContent className="p-4 space-y-4">
							...
							<DropdownMenu>
								...
								<DropdownMenuContent align="end">
									{(() => {
										...
										const wmMilestone =
											fieldWeld.component?.milestones?.find(
												(m) =>
													m.milestoneName === "Weld",
											);
										const isComplete =
											!!dateWelded ||
											wmMilestone?.isCompleted === true;
					...
					<div className="grid grid-cols-2 gap-3 text-sm">
						<div className="space-y-2">
							<div className="flex items-center gap-2">
								...
								<span className="font-medium">
									Package: {fieldWeld.packageNumber}
								</span>
							</div>
							<div className="flex items-center gap-2">
							...
							<div className="flex items-center gap-2">
								...
								<span>
									{(() => {
										...
										if (
											wmMilestone?.isCompleted &&
											wmMilestone.completedAt
										) {
						...
						<div className="space-y-2">
							<div>
								<span className="font-medium">
									Size: {fieldWeld.weldSize}
								</span>
								<br />
								<span className="text-muted-foreground">
									Sch {fieldWeld.schedule}
								</span>
							</div>
							{fieldWeld.welder && (
								<div className="flex items-center gap-2">
							...
							<div className="flex items-center justify-between">
								{fieldWeld.component ? (
									<span className="text-sm font-medium">
										Component:{" "}
										{fieldWeld.component.componentId}
									</span>
								) : (
					...
					{(() => {
						...
						const isComplete =
							!!dateWelded || wmMilestone?.isCompleted === true;
						return (
							(!isComplete && onMarkComplete) ||
							(!fieldWeld.ndeResult && (onApprove || onReject))
						);
					})() ? (
