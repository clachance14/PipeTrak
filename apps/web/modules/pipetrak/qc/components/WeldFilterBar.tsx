...
const QC_PRESETS = [
	...
	},
	{
		...
		filters: {
			...DEFAULT_FILTERS,
			dateWeldedFrom: new Date().toISOString().split("T")[0],
		},
	},
] as const;
...
export function WeldFilterBar({
	...
	const filterOptions = useMemo(() => {
		...
		fieldWelds.forEach((weld) => {
			if (weld.packageNumber && weld.packageNumber !== "TBD")
				packageNumbers.add(weld.packageNumber);
	...
	const hasActiveFilters = Object.entries(filters).some(([key, value]) => {
		if (key === "search" || key.includes("From") || key.includes("To"))
			return value !== "";
		return value !== "all";
	});
			...
			<div className="flex flex-col gap-4">
				...
				<div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2">
					...
					<Select
						...
						onValueChange={(value) =>
							handleFilterChange("packageNumber", value)
						}
					>
						<SelectTrigger>
						...
						<SelectContent>
							...
							{filterOptions.packageNumbers.map(
								(packageNumber) => (
									<SelectItem
										key={packageNumber}
										value={packageNumber}
					...
					<Select
						...
						onValueChange={(value) =>
							handleFilterChange("weldStatus", value)
						}
					>
						<SelectTrigger>
					...
					<Select
						...
						onValueChange={(value) =>
							handleFilterChange("ndeResult", value)
						}
					>
						<SelectTrigger>
					...
					<Select
						...
						onValueChange={(value) =>
							handleFilterChange("pwhtStatus", value)
						}
					>
						<SelectTrigger>
				...
				{showAdvanced && (
					<div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-2 pt-2 border-t">
						...
						<Select
							...
							onValueChange={(value) =>
								handleFilterChange("drawing", value)
							}
						>
							<SelectTrigger>
						...
						<Select
							...
							onValueChange={(value) =>
								handleFilterChange("welder", value)
							}
						>
							<SelectTrigger>
						...
						<Select
							...
							onValueChange={(value) =>
								handleFilterChange("weldType", value)
							}
						>
							<SelectTrigger>
						...
						<Select
							...
							onValueChange={(value) =>
								handleFilterChange("weldSize", value)
							}
						>
							<SelectTrigger>
			...
			<div className="flex items-center justify-between text-sm text-muted-foreground border-t pt-3">
				<div className="flex items-center gap-2">
					...
					<span>
						...
						<strong>{totalCount}</strong> field welds
					</span>
					{hasActiveFilters && (
