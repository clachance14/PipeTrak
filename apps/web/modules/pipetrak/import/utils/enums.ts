...
export function getComponentTypeOptions() {
  return [
    { value: 'SPOOL', label: 'Spool', description: 'Piping spool assembly' },
    { value: 'PIPING_FOOTAGE', label: 'Piping Footage', description: 'Linear piping sections' },
    { value: 'THREADED_PIPE', label: 'Threaded Pipe', description: 'Threaded piping connections' },
    { value: 'FITTING', label: 'Fitting', description: 'Pipe fittings (elbows, tees, reducers, etc.)' },
    { value: 'VALVE', label: 'Valve', description: 'All valve types' },
    { value: 'FLANGE', label: 'Flange', description: 'Flanges (weld neck, slip-on, blind, etc.)' },
    { value: 'GASKET', label: 'Gasket', description: 'Gaskets and sealing elements' },
    { value: 'SUPPORT', label: 'Support', description: 'Pipe supports and hangers' },
    { value: 'FIELD_WELD', label: 'Field Weld', description: 'Field welding work' }
  ];
}
...
export function getWorkflowTypeOptions() {
  return [
    { value: 'MILESTONE_DISCRETE', label: 'Discrete Milestones', description: 'Checkbox-based milestones (complete/incomplete)' },
    { value: 'MILESTONE_PERCENTAGE', label: 'Percentage Milestones', description: 'Percentage-based progress tracking' },
    { value: 'MILESTONE_QUANTITY', label: 'Quantity Milestones', description: 'Quantity-based progress tracking' }
  ];
}
 ...
 */
export function getWorkflowTypeForComponent(componentType: ComponentType): WorkflowType {
