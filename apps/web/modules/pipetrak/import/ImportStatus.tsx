  ...
  const getStatusMessage = () => {
    if (jobData) {
      switch (status) {
        ...
        case "partial":
          const partialSuccess = (jobData.processedRows || 0) - (jobData.errorRows || 0);
    ...
    <div className="space-y-6">
          ...
          <span className="font-medium">
            ...
            {jobData && (
              <span className="text-muted-foreground ml-2">
                ({jobData.processedRows || 0} of {jobData.totalRows || 0} rows)
              </span>
            )}
          </span>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold">
                  {jobData ? `${jobData.processedRows || 0}/${jobData.totalRows || 0}` : `${progress}%`}
                </p>
              </div>
            </div>
          </CardContent>
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold">
                  {jobData ? (jobData.processedRows || 0) - (jobData.errorRows || 0) : 0}
                </p>
              </div>
            </div>
          </CardContent>
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold">{jobData?.errorRows || 0}</p>
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      {hasErrors && (
        <Alert variant="destructive">
          ...
          <AlertDescription>
            Some components could not be imported. Please review the error log above
            and download the error report for details.
          </AlertDescription>
        </Alert>
      )}
    </div>
