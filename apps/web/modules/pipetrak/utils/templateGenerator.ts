...
export function generateFieldWeldTemplate(): Blob {
  ...
  const instructions = [
    ...
    [''],
    ['FIELD DESCRIPTIONS:'],
    ['Weld ID', 'Unique identifier for this field weld (e.g., FW-001, WELD-123)'],
    ['Component Type', 'Must be "FIELD_WELD" for dual tracking'],
    ['Drawing ID', 'Drawing where this weld appears (must exist in project)'],
    ['Weld Size', 'Nominal pipe size or weld dimension'],
    ['Schedule', 'Pipe schedule or wall thickness designation'],
    ['Weld Type Code', 'BW=Butt Weld, SW=Socket Weld, TW=Threaded Weld, etc.'],
    ['Base Metal', 'Material specification being welded'],
    ['X-ray Percent', 'Percentage of weld requiring radiographic testing (0-100)'],
  ...
  const validationLists = [
    ['Weld Types', 'NDE Methods', 'PWHT Options', 'Common Schedules', 'Base Materials'],
...
export function generateImportTemplate(): Blob {
  ...
  const instructions = [
    ...
    [''],
    ['FIELD DESCRIPTIONS:'],
    ['Commodity Code', 'Standard commodity/catalog code (e.g., A216WCB-6-150-GATE). Leave blank for auto-generation'],
    ['Component Type', 'Type of component (e.g., Valve, Pipe, Flange). Used for auto-generating IDs'],
    ['Drawing ID', 'Reference to the drawing where component appears (required)'],
  ...
  const validationLists = [
    ['Areas', 'Systems', 'Test Packages', 'Component Types', 'MTO Status', 'Priorities'],
    ['Unit 1', 'Cooling Water', 'TP-001', 'Pipe Spool', 'Released', 'Priority 1'],
    ['Unit 2', 'Process Steam', 'TP-002', 'Valve', 'Hold', 'Priority 2'],
    ['Unit 3', 'Feed Water', 'TP-003', 'Flange', 'Pending', 'Priority 3'],
    ['Unit 4', 'Natural Gas', 'TP-004', 'Fitting', 'Canceled', 'Priority 4'],
