      ...
      <div className={cn(
        ...
        {includeHeader && (
          <div className="print-header hidden">
            <div>
              <div className="text-lg font-bold">{title || "PipeTrak Report"}</div>
              {projectInfo && (
                <div className="text-sm text-gray-600">
                  {projectInfo.jobNumber} - {projectInfo.jobName}
                </div>
              )}
            </div>
        ...
        {includeFooter && (
          <div className="print-footer hidden">
            <div suppressHydrationWarning>
              Generated by PipeTrak on {new Date().toLocaleDateString()} at {new Date().toLocaleTimeString()}
            </div>
            <div>
              Page <span className="page-number"></span> of <span className="page-count"></span>
            </div>
          </div>
        )}
      </div>
