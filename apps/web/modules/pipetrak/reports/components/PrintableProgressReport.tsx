		...
		>
			...
			<div className="mt-8 print-break-inside-avoid">
				...
				<div className="text-sm text-gray-700 space-y-2">
					<p>
						• This report reflects component progress as of the
						Tuesday 9:00 AM cutoff for the specified week.
					</p>
					<p>
					...
					{options.showDeltas && (
						<p>
							• Week-over-week changes are shown in parentheses
							below each percentage.
						</p>
					)}
					<p>
						• Components are grouped by{" "}
						{getGroupColumnName().toLowerCase()} for this report
						view.
					</p>
				</div>
			</div>
