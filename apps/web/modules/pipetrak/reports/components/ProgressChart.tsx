...
import type { ProgressChartData, TrendDataPoint, ChartDataPoint } from "../types";
...
export function ProgressChart({
  ...
  const renderDistributionChart = (chartData: ChartDataPoint[], title: string) => {
    if (type === "pie") {
      return (
        <ResponsiveContainer width="100%" height={height}>
          <PieChart>
  ...
  const getTrendIcon = () => {
    ...
    const isIncreasing = recent[1]?.completionPercent > recent[0]?.completionPercent;
        ...
        {trendData ? (
          ...
          <Tabs defaultValue="areas" className="w-full">
            ...
            <TabsContent value="areas" className="mt-4">
              {renderDistributionChart(data.areaDistribution, "Area Distribution")}
            </TabsContent>
            
            <TabsContent value="systems" className="mt-4">
              {renderDistributionChart(data.systemDistribution, "System Distribution")}
            </TabsContent>
            
            <TabsContent value="status" className="mt-4">
              {renderDistributionChart(data.statusDistribution, "Status Distribution")}
            </TabsContent>
          </Tabs>
        ) : (
          <div className="flex items-center justify-center h-64 text-muted-foreground">
