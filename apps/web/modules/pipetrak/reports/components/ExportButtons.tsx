                ...
                <div>
                  ...
                  <div className="flex gap-2 mt-2">
                    {["excel", "pdf", "csv"].map((format) => (
                      <Button
                        key={format}
                        variant={exportOptions.type === format ? "default" : "outline"}
                        size="sm"
                ...
                <div>
                  ...
                  <div className="flex gap-2 mt-2">
                    {["portrait", "landscape"].map((orientation) => (
                      <Button
                        key={orientation}
                        variant={printOptions.orientation === orientation ? "default" : "outline"}
                        size="sm"
                        onClick={() => setPrintOptions(prev => ({
                          ...prev,
                          orientation: orientation as PrintOptions['orientation']
                        }))}
                      >
                ...
                <div>
                  ...
                  <div className="flex gap-2 mt-2">
                    {["a4", "letter"].map((size) => (
                      <Button
                        key={size}
                        variant={printOptions.paperSize === size ? "default" : "outline"}
                        size="sm"
                        onClick={() => setPrintOptions(prev => ({
                          ...prev,
                          paperSize: size as PrintOptions['paperSize']
                        }))}
                      >
                        {size.toUpperCase()}
                      </Button>
                ...
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => setPrintOptions(prev => ({
                        ...prev,
                        includeCharts: checked as boolean
                      }))}
                    />
                    <Label htmlFor="printCharts">Include charts</Label>
                  </div>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="printHeader">Include header</Label>
                  </div>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="printFooter">Include footer</Label>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-end gap-2">
                  ...
                  <Button 
                    ...
                    disabled={!emailOptions.recipients.trim() || isExporting}
                  >
                    {isExporting ? (
                      <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                    ) : (
