...
describe("ComponentCountBadge", () => {
	describe("default variant", () => {
		it("should render status badges with counts", () => {
			...
			expect(
				screen.getByText("10", { selector: ":nth-of-type(2)" }),
			).toBeInTheDocument(); // inProgress
	...
	describe("compact variant", () => {
		...
		it("should apply color based on completion percentage", () => {
			...
			expect(
				container1.querySelector(".border-green-500"),
			).toBeInTheDocument();
			...
			expect(
				container2.querySelector(".border-blue-500"),
			).toBeInTheDocument();
			...
			expect(
				container3.querySelector(".border-gray-400"),
			).toBeInTheDocument();
		});
	});
	...
	describe("edge cases", () => {
		...
		it("should handle very large numbers", () => {
			...
			render(<ComponentCountBadge componentCount={largeNumbers} />);
