...
describe("DrawingTreeView", () => {
	...
	describe("rendering", () => {
		...
		it("should show empty message when no drawings", () => {
			render(
				<DrawingTreeView {...defaultProps} drawings={mockEmptyTree} />,
			);
	...
	describe("search functionality", () => {
		...
		it("should show no results message when search has no matches", async () => {
			...
			expect(
				screen.getByText("No drawings found matching your search"),
			).toBeInTheDocument();
		});
	...
	describe("expand/collapse functionality", () => {
		...
		it("should handle deep tree expansion", () => {
			render(
				<DrawingTreeView {...defaultProps} drawings={mockDeepTree} />,
			);
			...
			expect(
				screen.getByText("AREA-01-UNIT-01-SYS-01"),
			).toBeInTheDocument();
		});
	});
