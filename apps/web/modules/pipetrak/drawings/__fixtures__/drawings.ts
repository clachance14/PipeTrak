import type { DrawingTreeNode, DrawingComponentCount, Drawing } from "../../types";
...
export const mockLargeTree: DrawingTreeNode[] = Array.from({ length: 50 }, (_, i) => ({
  id: `root-${i}`,
  projectId: "p1",
  ...
  children: Array.from({ length: 10 }, (_, j) => ({
    ...
    createdAt: new Date("2024-01-02"),
    updatedAt: new Date("2024-01-02"),
    componentCount: j % 3 === 0 ? mockComponentCounts.allComplete : mockComponentCounts.inProgress,
    children: [],
  })),
}));
