...
import { ComponentType, WorkflowType } from "@repo/database/prisma/generated/client";
...
export const COMPONENT_TYPE_ROC_TEMPLATE: Record<ComponentType, keyof typeof ROC_MILESTONE_WEIGHTS> = {
  // Full milestone set (7 milestones)
