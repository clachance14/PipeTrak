      ...
      <CardContent className="space-y-3">
        ...
        {hasOrganization ? (
          ...
          <Alert variant="destructive" className="py-2">
            ...
            <AlertTitle className="text-sm">No Active Organization</AlertTitle>
            <AlertDescription className="text-xs mt-1">
              You are not a member of any organization. Contact an administrator to be added.
            </AlertDescription>
          </Alert>
        )}
        ...
        {hasOrganization && !hasMembership && (
          <Alert variant="destructive" className="py-2">
            <AlertCircle className="h-4 w-4" />
            <AlertTitle className="text-sm">Not a Member</AlertTitle>
            <AlertDescription className="text-xs mt-1">
              You can see this organization but are not a member. You won't be able to access resources.
            </AlertDescription>
          </Alert>
        )}
        ...
        {!hasOrganization && user?.id && (
          <div className="pt-2 border-t">
            <p className="text-xs text-muted-foreground mb-1">Quick Fix SQL:</p>
