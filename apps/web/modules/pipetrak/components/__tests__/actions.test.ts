...
describe("API Actions", () => {
  ...
  describe("getComponents", () => {
    it("should fetch and transform components successfully", async () => {
      ...
      (apiClient.pipetrak.components.$get as any).mockResolvedValue(mockResponse);
    ...
    it("should handle API errors gracefully", async () => {
      ...
      expect(mockConsoleError).toHaveBeenCalledWith("Failed to fetch components");
    });
  ...
  describe("updateComponentMilestone", () => {
    it("should update milestone successfully", async () => {
      ...
      (apiClient.pipetrak.milestones[":id"].$patch as any).mockResolvedValue(
        mockResponse
      );
      ...
      expect(apiClient.pipetrak.milestones[":id"].$patch).toHaveBeenCalledWith({
    ...
    it("should handle network errors", async () => {
      (apiClient.pipetrak.milestones[":id"].$patch as any).mockRejectedValue(
        new Error("Network error")
      );
  ...
  describe("getComponentDetails", () => {
    it("should fetch and transform component details successfully", async () => {
      ...
      (apiClient.pipetrak.components[":id"].$get as any).mockResolvedValue(
        mockResponse
      );

      const result = await getComponentDetails("comp-1");

      expect(apiClient.pipetrak.components[":id"].$get).toHaveBeenCalledWith({
        param: { id: "comp-1" },
      });
    ...
    it("should handle network errors gracefully", async () => {
      (apiClient.pipetrak.components[":id"].$get as any).mockRejectedValue(
        new Error("Network error")
      );
  ...
  describe("bulkUpdateComponents", () => {
    it("should bulk update components successfully", async () => {
      ...
      (apiClient.pipetrak.components.bulk.$patch as any).mockResolvedValue(
        mockResponse
      );
      ...
      expect(apiClient.pipetrak.components.bulk.$patch).toHaveBeenCalledWith({
    ...
    it("should handle network errors", async () => {
      (apiClient.pipetrak.components.bulk.$patch as any).mockRejectedValue(
        new Error("Network error")
      );
  ...
  describe("exportComponents", () => {
    it("should export components as CSV successfully", async () => {
      ...
      (apiClient.pipetrak.components.export.$get as any).mockResolvedValue(
        mockResponse
      );

      const result = await exportComponents("proj-1", "csv");

      expect(apiClient.pipetrak.components.export.$get).toHaveBeenCalledWith({
    ...
    it("should handle network errors", async () => {
      (apiClient.pipetrak.components.export.$get as any).mockRejectedValue(
        new Error("Network error")
      );
