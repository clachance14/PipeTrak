  ...
  return (
    <HoverCard openDelay={400} closeDelay={100}>
      ...
      >
        ...
        <div className="space-y-2">
          <div className="flex items-start justify-between">
            <div>
              ...
              {component.displayId && component.displayId !== component.componentId && (
                <p className="text-xs text-muted-foreground">
                  {component.displayId}
                </p>
              )}
            </div>
            <Badge variant={component.status === "COMPLETED" ? "success" : "secondary"}>
              {component.status}
            </Badge>
          </div>
            ...
            {component.size && (
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="font-medium">{component.size}</p>
                </div>
              </div>
            )}
            ...
            {component.material && (
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="font-medium">{component.material}</p>
                </div>
              </div>
            )}
            ...
            {component.spec && (
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="font-medium">{component.spec}</p>
                </div>
              </div>
            )}
          </div>
              ...
              <div className="space-y-2 text-sm">
                {component.drawingNumber && (
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-medium">{component.drawingNumber}</span>
                  </div>
                )}
                ...
                {component.area && (
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-medium">{component.area}</span>
                  </div>
                )}
                ...
                {component.system && (
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-medium">{component.system}</span>
                  </div>
                )}
              </div>
            </div>
              ...
              <div className="grid grid-cols-2 gap-3 text-sm">
                {component.totalQuantity && (
                  <div>
                    ...
                    <p className="font-medium">
                      {component.totalQuantity} {component.quantityUnit || 'units'}
                    </p>
                  </div>
                )}
                ...
                {component.totalLength && (
                  <div>
                    ...
                    <p className="font-medium">
                      {component.totalLength} {component.lengthUnit || 'ft'}
                    </p>
                  </div>
                )}
              </div>
            ...
            <div className="flex items-center gap-4 text-xs text-muted-foreground">
              ...
              {component.installationDate && (
                <div className="flex items-center gap-1">
                  <Calendar className="h-3 w-3" />
                  <span>
                    Installed: {new Date(component.installationDate).toLocaleDateString()}
                  </span>
                </div>
              )}
            </div>
        ...
        {component.instanceNumber && component.totalInstancesOnDrawing && (
          <>
            <Separator className="my-3" />
            <div className="flex items-center justify-between text-xs">
              <span className="text-muted-foreground">
                Instance {component.instanceNumber} of {component.totalInstancesOnDrawing}
              </span>
