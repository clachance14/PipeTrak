  ...
  const validateMilestoneData = () => {
    switch (workflowType) {
      ...
      case "MILESTONE_QUANTITY":
        return milestone.quantityComplete !== undefined && milestone.quantityTotal !== undefined;
  ...
  if (!isValidMilestone) {
    return (
      <Alert variant="destructive" className={className}>
        ...
        <AlertDescription>
          Milestone data is incompatible with workflow type "{workflowType}".
          Please check the milestone configuration.
        </AlertDescription>
      </Alert>
    );
  }
      ...
      return (
        <Alert variant="destructive" className={className}>
          ...
          <AlertDescription>
            ...
            Supported types are MILESTONE_DISCRETE, MILESTONE_PERCENTAGE, and MILESTONE_QUANTITY.
          </AlertDescription>
        </Alert>
      );
  }
