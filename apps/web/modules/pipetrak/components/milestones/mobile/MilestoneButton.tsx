...
export const MilestoneButton = memo(function MilestoneButton({
	...
	const getButtonStyles = () => {
		const baseStyles =
			"h-10 w-full min-w-[40px] flex flex-col items-center justify-center gap-0.5 p-0.5 text-xs font-medium rounded-md transition-all duration-200 active:scale-95";
