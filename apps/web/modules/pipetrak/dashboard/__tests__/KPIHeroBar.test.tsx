...
describe('KPIHeroBar', () => {
  describe('Loading State', () => {
    ...
    it('renders loading skeletons with proper structure', () => {
      ...
      const skeletonDivs = document.querySelectorAll('.animate-pulse .h-4.bg-gray-300');
  ...
  describe('Visual Elements', () => {
    it('renders correct icons for each KPI card', () => {
      ...
      const cards = screen.getAllByRole('generic').filter(el => 
        el.classList.contains('grid') === false // Exclude the grid container
      );
  ...
  describe('Responsive Layout', () => {
    it('applies correct grid classes for responsive layout', () => {
      ...
      const gridContainer = container.querySelector('.grid.gap-4.grid-cols-2.lg\\:grid-cols-5');
  ...
  describe('Test Package Logic', () => {
    it('correctly counts ready packages', () => {
      const mixedPackages = {
        testPackages: [
          { packageId: '1', packageName: 'Package 1', totalComponents: 5, completedComponents: 5, completionPercent: 100, isReady: true, stalledCount: 0 },
          { packageId: '2', packageName: 'Package 2', totalComponents: 3, completedComponents: 1, completionPercent: 33, isReady: false, stalledCount: 1 },
          { packageId: '3', packageName: 'Package 3', totalComponents: 4, completedComponents: 4, completionPercent: 100, isReady: true, stalledCount: 0 },
        ],
