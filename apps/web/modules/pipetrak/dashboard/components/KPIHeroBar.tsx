  ...
  return (
    <div className="grid gap-4 grid-cols-2 lg:grid-cols-5 w-full">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">
            {metrics.completedComponents.toLocaleString()} / {metrics.totalComponents.toLocaleString()}
          </div>
          <p className="text-xs text-muted-foreground">
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-sm font-medium">Test Pkgs</CardTitle>
      ...
      <Card className="border-orange-200 bg-orange-50/50 col-span-2 lg:col-span-1">
        ...
        <CardContent>
          ...
          <div className="text-xs text-muted-foreground space-y-0.5">
            ...
            <div>14d: {metrics.stalledComponents.stalled14Days}</div>
            <div>21d: {metrics.stalledComponents.stalled21Days}</div>
          </div>
        </CardContent>
      </Card>
    </div>
