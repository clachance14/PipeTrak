...
export function MobileDashboard({
  ...
  const loadComponents = async () => {
    ...
    try {
      ...
      const result = await fetchDashboardComponentsClient(projectId, filters, 50, 0); // Limit to 50 for mobile
  ...
  const handleMilestoneToggle = async (componentId: string, milestoneId: string, completed: boolean) => {
    ...
    if (selectedComponent?.id === componentId) {
      ...
      setSelectedComponent({ ...selectedComponent, milestones: updatedMilestones });
    }
  };
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              {availableProjects.length > 1 ? (
                ...
                <h1 className="font-semibold text-base truncate">{projectName}</h1>
              )}
            </div>
      ...
      <div className="bg-white border-b px-4 py-3">
        <div className="space-y-3">
          ...
          >
            ...
            <ToggleGroupItem value="matrix" aria-label="Matrix View" className="flex-1">
            ...
            <div className="p-4 space-y-3">
              ...
              components.map((component) => (
                <MobileComponentCard
                  key={component.id}
                  component={component}
                  onTap={() => handleComponentTap(component)}
                />
              ))
              )}
            </div>
    ...
    >
      ...
      <div className="mb-3">
        ...
        <div className="flex justify-between mt-1 text-xs text-muted-foreground">
          ...
          {hasMoreMilestones && (
            <span>Tap for all milestones</span>
          )}
        </div>
      </div>
