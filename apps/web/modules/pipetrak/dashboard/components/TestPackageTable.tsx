        ...
        <div className="flex items-center gap-2">
          {testPackage.isReady ? (
            ...
            <Badge variant="secondary">
              {testPackage.completedComponents}/{testPackage.totalComponents}
            </Badge>
          )}
...
export function TestPackageTable({ data }: TestPackageTableProps) {
  ...
  const [sortBy, setSortBy] = useState<'completion' | 'name' | 'components'>('completion');
    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Track completion status of test packages and readiness indicators.
          </CardDescription>
        </CardHeader>
        <CardContent>
    ...
    <Card>
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription>
              {stats.total} packages, {stats.ready} ready for testing
      ...
      <CardContent>
        ...
        <div className="flex items-center justify-between text-sm text-muted-foreground mt-4">
          <div>
            Showing {filteredAndSortedPackages.length} of {stats.total} packages
          </div>
          <div>
            {Math.round((stats.ready / stats.total) * 100)}% packages ready
          </div>
        </div>
      </CardContent>
    </Card>
