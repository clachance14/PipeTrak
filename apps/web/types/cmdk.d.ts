...
declare module "cmdk" {
	...
	export interface CommandComponents {
		Input: ForwardRefExoticComponent<
			CommandInputProps & RefAttributes<HTMLInputElement>
		>;
		List: ForwardRefExoticComponent<
			CommandListProps & RefAttributes<HTMLDivElement>
		>;
		Empty: ForwardRefExoticComponent<
			CommandEmptyProps & RefAttributes<HTMLDivElement>
		>;
		Group: ForwardRefExoticComponent<
			CommandGroupProps & RefAttributes<HTMLDivElement>
		>;
		Item: ForwardRefExoticComponent<
			CommandItemProps & RefAttributes<HTMLDivElement>
		>;
		Separator: ForwardRefExoticComponent<
			CommandSeparatorProps & RefAttributes<HTMLDivElement>
		>;
	}

	declare const Command: ForwardRefExoticComponent<
		CommandProps & RefAttributes<HTMLDivElement>
	> &
		CommandComponents;
