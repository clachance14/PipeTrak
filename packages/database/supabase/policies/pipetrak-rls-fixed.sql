...
CREATE POLICY "Users can view projects in their organizations"
  ...
  USING ("organizationId" IN (SELECT public.user_organizations()));
...
CREATE POLICY "Users can view drawings in their organizations"
  ...
  USING (
    "projectId" IN (
      ...
      WHERE "organizationId" IN (SELECT public.user_organizations())
    )
  );
...
CREATE POLICY "Users can view component milestones in their organizations"
  ...
  USING (
    "componentId" IN (
      ...
      WHERE p."organizationId" IN (SELECT public.user_organizations())
    )
  );
