...
async function applySupabaseFunctions() {
  ...
  try {
    ...
    // Read the SQL file
    const sqlPath = path.join(__dirname, '../../../packages/database/supabase/functions/pipetrak-functions-fixed.sql');
    ...
    try {
      ...
      `, ['clzr8yc5w002rr0iq5j5gnx9k']); // Using the Project ID from seed data
